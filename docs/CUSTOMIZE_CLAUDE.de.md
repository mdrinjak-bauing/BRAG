...
**`RAG-Verbindungsordner/CLAUDE.md`** auszufüllen. Sie wird von Claude automatisch
...
`RAG-Verbindungsordner/AGENTS.md` enthält **Zusatzregeln für autonomes Arbeiten** — wenn
